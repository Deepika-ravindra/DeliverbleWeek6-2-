...
public class CalculatorPage {
	...
	public String doSub(String v3, String v4) throws Throwable {
		driver.findElement(first).clear();
		driver.findElement(first).sendKeys(v3);
		driver.findElement(second).clear();
		driver.findElement(second).sendKeys(v4);
		Thread.sleep(3000);
		driver.findElement(operator).sendKeys("-");
		Thread.sleep(3000);
